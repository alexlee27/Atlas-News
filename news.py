...
api = NewsApiClient(api_key = "371041ed67cb42ddb04a0131a59203fb")
...
list_of_countries = {
    ...
    "Portugal": "pt", "Romania": "ro", "Serbia": "rs", "Russian Federation": "ru", "Saudi Arabia": "sa", "Sweden": "se",
...
def search(query: str, country =None, sources=None, lang= "en"):
    ...
    x = api.get_everything(q= query, sources= sources, language = lang, sort_by="popularity")
    return x["articles"]
...
def getCountryNews(country):
    ...
    """
    return api.get_top_headlines(q=country, country= list_of_countries[country], page_size=1)
